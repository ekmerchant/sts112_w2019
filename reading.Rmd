...
## Week 8
### [Ethnicity and the Boundaries of Race: Rereading Directive 15](https://www.jstor.org/stable/20027961)
**Victoria Hattam, 2006, *Daedalus* 134: 61-69.** 

As you read this article, pay particular attention to the following things:

- What is Statistical Policy Directive 15? How has it contributed to the historical construction of race and ethnicity in the United States?
- Where did the concept of ethnicity come from?
- Why is Hispanic the only ethnic group for which the federal government collects statistics?
- When and why were Americans allowed to start choosing more than one race category in the census?
- What is the “dialogic” relationship Hattam describes between race and ethnicity? What is its effect?
- Why does Hattam describe the “some other race” category as a “political safety valve”? What data issues are raised by this category? How does the Census Bureau address them?
- What are the political implications of the racial identification of Hispanic Americans?
- What does Hattam recommend for the 2010 Census?
...
This is a difficult article, with some complicated theoretical concepts and technical analysis. Focus on the overall argument about the intersection of racial and gender inequality in paid reproductive labor, and on how Duffy uses analysis of IPUMS data to make this argument. In particular, note how she classifies race and occupational categories, and how she justifies her choices.
...
As you read this article, note each time the authors make an assumption about how people identify their race and each time they make a decision about how they will analyze their data. As you notice these things happening, think about whether they are adequately explaining or justifying their decisions or assumptions. Compare to last week's article by Mignon Duffy.
...
As you read this article, think about how you would investigate or illustrate the points the authors are making using IPUMS data for 2000. That is what we will be doing in the lab!